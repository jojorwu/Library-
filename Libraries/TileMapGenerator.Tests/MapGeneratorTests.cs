...
public class MapGeneratorTests
{
    ...
    public void Generate_WithValidInputs_ReturnsMapWithCorrectDimensions()
    {
        ...
        var map = generator.Generate(10, 20, 10.0f, mappings, new List<Structure>(), new List<PlacedStructure>());
    ...
    public void Generate_WithValidInputs_ReturnsMapWithCorrectTileIds()
    {
        ...
        var map = generator.Generate(10, 10, 10.0f, mappings, new List<Structure>(), new List<PlacedStructure>());
    ...
    public void Generate_WithPlacedStructure_PlacesStructureAtCorrectCoordinates()
    {
        ...
        var map = generator.Generate(10, 10, 1.0f, mappings, new List<Structure>(), placedStructures);
    ...
    public void Generate_WithRandomStructure_PlacesStructureOnMap()
    {
        ...
        var map = generator.Generate(10, 10, 1.0f, mappings, randomStructures, new List<PlacedStructure>());
